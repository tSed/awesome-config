...
browsers = { "chromium", "firefox", "epiphany" }
viewer_image = "eog"
viewer_pdf = "evince"
ide = "qtcreator"
suite_office = "libreoffice"
suite_graphic = "gimp"
...
myappsmenu = { { editor, editor_cmd },
               { "QtCreator", ide },
               { viewer_pdf, viewer_pdf },
               { "image viewer",  viewer_image },
               { suite_office, suite_office },
               { suite_graphic, suite_graphic }
             }

mybrowsermenuitems = {}
for i, v in ipairs(browsers) do
    mybrowsermenuitems[i] = { v, v }
    table.insert(myappsmenu, { v, v })
end
...
-- Web browser menu
mybrowsermenu = awful.menu({ items = mybrowsermenuitems })

mybrowserlauncher = awful.widget.launcher({ menu = mybrowsermenu })
-- }}}
...
keybindings = {
  ...
  -- {{{ my key bindings
  {
    ...
    awesome_restart       = { { modkey, "Control"        }, "r" },
    awesome_quit          = { { modkey, "Shift"          }, "q" },
    browser_menu          = { { modkey, "Control", "Shift" }, "w" },
    spawn_browser         = { { modkey, "Control"        }, "w" },
    spawn_text_editor     = { { modkey, "Control"        }, "e" },
...
globalkeys = awful.util.table.join(
    ...
    awful.key(keys.spawn_browser[1], keys.spawn_browser[2], function () awful.util.spawn(browsers[1]) end),
